...
function PostContent({ onCommentClick,text="ro7 bla dsara", hashtags=["djazayr ya ma", "salowat"], image,likes = 0, comments = 0, shares = 0, }) {
  ...
  return (
    <div className="px-4 pt-5 pb-2">
      ...
      <div className="flex items-center space-x-6">
        <Like postId={selectedPost} likes={likes} />
        <div onClick={() => {
